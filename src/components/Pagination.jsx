...
const Pagination = () => {
  return (
    <div className="flex gap-6 pt-4 pb-4 justify-center items-center">
      ...
      <span className="text-[#4D4D4D] text-sm">1</span>
      <span className="text-[#4D4D4D] text-sm">...</span>
      <span className="bg-[#146EB4] px-2 py-1 rounded-[4px] text-white">
        10
      </span>
      <span className="text-[#4D4D4D] text-sm">11</span>
      <span className="text-[#4D4D4D] text-sm">12</span>
      <span className="text-[#4D4D4D] text-sm">13</span>
      <span className="text-[#4D4D4D] text-sm">14</span>
      <span className="text-[#4D4D4D] text-sm">15</span>
      <span className="text-[#4D4D4D] text-sm"> 16</span>
      <span className="text-[#4D4D4D] text-sm">17</span>
      <span className="text-[#4D4D4D] text-sm">18</span>
      <button className="flex items-center gap-2 rounded-[4px] border border-[#D9D9D9] py-1 px-2">
